...
//User add to cart functionality
...
function howManyItems(itemNames){
  ...
  inquirer.prompt([
    ...
    //Compare to amount in stock
    validate: function(str){
        if (parseInt(str) <= itemStock) {
          return true
        } else {
          //Else Number in Stock
...
//Function to Edit the Shopping Cart
function editCart(){
  var items = [];
  for (var i = 0; i < shoppingCart.length; i++) {
    var item = shoppingCart[i].item;
